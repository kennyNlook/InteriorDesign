    ...
    <div class="" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link text-white " href="dashbord.jsp">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">receipt_long</i>
            </div>
            <span class="nav-link-text ms-1">upload New project</span>
          </a>
        </li>
       <li class="nav-item">
       ...
       <form action="logout" methot="post">
        <li class="nav-item">
          <a class="nav-link text-white ">
            ...
            <span class="nav-link-text ms-1" name="logout"><input type="submit" value="logout" name="logout"></span>
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                ...
                <span class="d-sm-inline d-none">LSogout</span>
              </a>
            </li>
            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Project Upload</h4>
                  <p class="mb-0">Fill information</p>
                </div>
                <div class="card-body">
                  <form role="form" action="Dash" method="post" enctype="multipart/form-data">
                  
                  
                  <div class="input-group input-group-outline mb-3">
                      <label class="form-label">Discription</label>
                      <input type="text" class="form-control" name="essage">
                    </div>
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0"  value="Send" >Upload</button>
                    </div>
                  </form>
                </div>
