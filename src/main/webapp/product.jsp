            ...
            <div class="col-xl-4 col-lg-5 col-md-7 d-flex flex-column ms-auto me-auto ms-lg-auto me-lg-5">
              <div class="card card-plain">
                <div class="card-header">
                  <h4 class="font-weight-bolder">Register Product</h4>
                  <p class="mb-0">Fill Product information</p>
                </div>
                <div class="card-body">
                  <form role="form" action="Register" method="post">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0"  value="Send" >send</button>
                    </div>
                  </form>
                </div>
