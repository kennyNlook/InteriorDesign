...
%>
                      ...
                      <td>
                      <p class="text-sm font-weight-bold mb-0"><%=resultSet.getString("names") %></p>
                     
                      </td>
                     <td>
                       <<p class="text-sm font-weight-bold mb-0"><%=resultSet.getString("phone") %></p>
                       
                      </td>
                      <td>
                       <p class="text-sm font-weight-bold mb-0"><%=resultSet.getString("address") %></p>
                       
                      </td>
                    
                      <td>
                       <p class="text-sm font-weight-bold mb-0"><%=resultSet.getString("street") %></p>
                       
                      </td>
                       <td>
                       <p class="text-sm font-weight-bold mb-0"><%=resultSet.getString("essage") %></p>
